...
LASER_OFFSET = property.getNumber('Laser Offset')
...
function onTick()
    ...
    laserDistance = input.getNumber(13) + LASER_OFFSET
    ...
    output.setNumber(1, relativeAzimuth / PI2)
    output.setNumber(2, relativeElevation / PI2)
    output.setNumber(3, target.relativePosition[1])
    output.setNumber(4, target.relativePosition[2])
    output.setNumber(5, target.relativePosition[3])
